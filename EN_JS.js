...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function redirectToLoader() {
        ...
        window.location.href = 'EN_Thanks_Loader.html';
...
if (sessionStorage.getItem('manuallyRefreshed')) {
    ...
    window.location.href = "EN_Main_Loading.html";
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const texts = [
        "A professional Data Analyst with more than five years of practical experience in the Techno-Logistics fields in the Israeli Defence Force (IDF)",
        "I own a BSc in Industrial and Management Engineering and an M.B.A in Business Administration, both with specialization in Information Systems",
        "As a UI/UX Designer, I specialize in creating a spectacular experience by using skills and combination of advanced technologies, creating distinct content and managing colors and graphics at the highest level",
        "I was born in Israel, I have lived here since forever, the Israel's culture and beauty is all I know, I'm still excited every moment I dream about it, I will never forget her and I will never leave!"
    ];
...
chatbotButton.onmousedown = function(event) {
    ...
    function moveAt(pageX, pageY) {
      ...
      chatbotButton.style.left = pageX - shiftX + 'px';
      chatbotButton.style.top = pageY - shiftY + 'px';
      
      exclamationMark.style.left = pageX - shiftX + 30 + 'px'; 
      exclamationMark.style.top = pageY - shiftY - 50 + 'px'; 
...
"Hello , how are you ?": "Hi there ! Thank you for asking me that . I'm just a bot , but I'm doing great ! How about you ?",
"Tell me about the content of this website": "In this portfolio you can find a lot of information and details about my great boss - Lishay Kroytoro .",
"What ways of contacting Lishay are available ?": "There are links to his social media platforms on the home tab , and you can also submit a personal form direct to his email on the contact tab .",
"How did he make you ?": "Using simple HTML , CSS and Javascript . Do you like me too ?",
"Thank you !": "You are very welcome , I will wait here if you need me .",
"Clear messages": "",
"Exit Chat": "Hope you enjoyed me as much as I enjoyed you . goodbye !"
...
chatbotButton.addEventListener('click', () => {
    ...
    if (!welcomeShown) {
        addMessage("Bot", "What can I help you with ? Is there anything you would like to know about me or about Lishay ?");
        welcomeShown = true;
    }
...
function handleQuestionClick(question) {
    ...
    const response = responses[question] || "I don't understand that .";
    addMessage("Bot", response, false); 

    if (question === "Clear messages") {
        clearAllMessages();
    } else if (question === "Exit Chat") {
    setTimeout(() => {
        closeChatbox();
    }, 2500);
    }
...
function clearAllMessages() {
    ...
    const senderElement = document.createElement('strong');
    senderElement.textContent = "Bot : ";
    noMessagesElement.appendChild(senderElement);
    const textNode = document.createTextNode("No new messages !");
